...
java -cp "calimero-server-2.6.jar:calimero-core-2.6.jar:calimero-device-2.6.jar:slf4j-api-2.0.17.jar:slf4j-simple-2.0.17.jar" tuwien.auto.calimero.server.Launcher server-config.xml
~~~
